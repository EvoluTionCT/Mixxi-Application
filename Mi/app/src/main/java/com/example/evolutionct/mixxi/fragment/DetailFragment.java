...
public class DetailFragment extends Fragment {
    ...
    private void setTexts() throws JSONException{
        ...
        final String d1 = new SimpleDateFormat("hh:mm a" , Locale.US).format(new Date(sr * 1000));
        final String d2 = new SimpleDateFormat("hh:mm a" , Locale.US).format(new Date(ss * 1000));
