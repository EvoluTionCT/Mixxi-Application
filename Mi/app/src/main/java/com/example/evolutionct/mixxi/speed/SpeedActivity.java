package com.example.evolutionct.mixxi.speed;
...
public class SpeedActivity extends AppCompatActivity implements LocationListener, GpsStatus.Listener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setTitle("");
        fab = (FloatingActionButton) findViewById(R.id.fab_speed);
